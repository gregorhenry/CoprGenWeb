...
<div class="navbar">
    <div class="row">
        <div class="column column-30 col-site-title"><a href="#" class="site-title float-left">Noche</a></div>
...
<div class="row">
    <div id="sidebar" class="column">
        ...
        <ul>
            ...
            <li><a href="#widgets"><em class="fa fa fa-clone"></em> Productos</a></li>
            <li><a href="#forms"><em class="fa fa-pencil-square-o"></em> Promociones</a></li>
            <li><a href="#alerts"><em class="fa fa-warning"></em> Alertas</a></li>
            <li><a href="#buttons"><em class="fa fa-hand-o-up"></em> Novedades</a></li>
            <li><a href="#tables"><em class="fa fa-table"></em> tipos de Contactos</a></li>
            <li><a href="#grid"><em class="fa fa-columns"></em> Vistas por fecha</a></li>
        </ul>
    </div>
